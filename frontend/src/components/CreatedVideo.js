  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto p-6">
        <h2 className="text-3xl font-bold text-red-500 mb-4">Created Video 1</h2>

        <div className="grid grid-cols-2 gap-6">
          <div className="bg-gray-300 p-10">[Video Preview]</div>

          <div>
            <button className="bg-gray-300 px-4 py-2 rounded mb-4" onClick={() => navigate('/created1/replace-video')}>
              Replace Video
            </button>
        ...
        <button className="bg-red-500 text-white px-4 py-2 mt-4 rounded">Delete Video</button>
      </main>
    </div>
  );
};
